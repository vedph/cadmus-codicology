...
/// <summary>
/// Illumination instructions part.
/// <para>Tag: <c>it.vedph.codicology.illum-instructions</c>.</para>
/// </summary>
[Tag("it.vedph.codicology.illum-instructions")]
public sealed class CodIllumInstructionsPart : PartBase
{
    /// <summary>
    /// Gets or sets the entries.
    /// </summary>
    public List<CodIllumInstruction> Instructions { get; set; } = [];
